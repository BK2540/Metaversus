    ...
    >
        ...
        >
          ...
          <div>
            ...
            <p className="font-normal mt-[8px] sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">Founder | Metaverus</p>
          </div>

          <p className="font-normal mt-[24px] sm:text-[24px] text-[18px] sm:leading-45px] leading-[39px] text-white">
